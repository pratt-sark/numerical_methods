...
//Program : Newton's Forward Interpolation
...
class InputSet
{
    ...
    void solve()
    {
        ...
        //cout<<"\n\nNumber of forward differences taken = "<<k<<endl;
        cout<<"\n\nThe Delta Vector = ";
